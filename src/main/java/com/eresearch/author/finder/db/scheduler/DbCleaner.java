package com.eresearch.author.finder.db.scheduler;
        ...
        transactionTemplate.execute(new TransactionCallbackWithoutResult() {
            ...
            protected void doInTransactionWithoutResult(TransactionStatus transactionStatus) {
                try {
                    ...
                    jdbcTemplate.update(authorFinderDao.getDeleteQueryForSearchResultsTable());
                    jdbcTemplate.update(authorFinderDao.getResetAutoIncrementForSearchResultsTable());
