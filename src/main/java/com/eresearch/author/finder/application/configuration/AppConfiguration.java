package com.eresearch.author.finder.application.configuration;

import com.codahale.metrics.MetricRegistry;
import com.codahale.metrics.health.HealthCheckRegistry;
import com.eresearch.author.finder.deserializer.InstantDeserializer;
import com.eresearch.author.finder.serializer.InstantSerializer;
...
public class AppConfiguration implements SchedulingConfigurer {
    ...
    public ExecutorService scopusAuthorSearchExecutor() {

        return new ThreadPoolExecutor(
                20, 120,
                5000L, TimeUnit.MILLISECONDS,
                new ArrayBlockingQueue<>(300, true),
                new ThreadFactoryBuilder().setNameFormat("scopus-author-seearch-thread-%d").build(),
